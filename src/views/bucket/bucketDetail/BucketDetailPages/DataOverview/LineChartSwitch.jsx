...
const ObjectsOption = {
    ...
    dataset: {
        dimensions: ["date", "存储用量"],
        source: [
            { date: "2023-04-17", 存储用量: 12 },
            { date: "2023-04-18", 存储用量: 12 },
            { date: "2023-04-19", 存储用量: 12 },
            { date: "2023-04-20", 存储用量: 12 },
            { date: "2023-04-21", 存储用量: 12 },
            { date: "2023-04-22", 存储用量: 12 },
            { date: "2023-04-23", 存储用量: 12 },
            { date: "2023-04-24", 存储用量: 9 },
            { date: "2023-04-25", 存储用量: 9 },
            { date: "2023-04-26", 存储用量: 9 },
            { date: "2023-04-27", 存储用量: 9 },
            { date: "2023-04-28", 存储用量: 9 },
            { date: "2023-04-29", 存储用量: 23 },
            { date: "2023-04-30", 存储用量: 23 },
            { date: "2023-05-01", 存储用量: 23 },
            { date: "2023-05-02", 存储用量: 24 },
            { date: "2023-05-03", 存储用量: 24 },
            { date: "2023-05-04", 存储用量: 24 },
            { date: "2023-05-05", 存储用量: 25 },
            { date: "2023-05-06", 存储用量: 25 },
            { date: "2023-05-07", 存储用量: 25 },
            { date: "2023-05-08", 存储用量: 10 },
            { date: "2023-05-09", 存储用量: 10 },
            { date: "2023-05-10", 存储用量: 10 },
            { date: "2023-05-11", 存储用量: 10 },
            { date: "2023-05-12", 存储用量: 23 },
            { date: "2023-05-13", 存储用量: 23 },
            { date: "2023-05-14", 存储用量: 23 },
            { date: "2023-05-15", 存储用量: 23 },
            { date: "2023-05-16", 存储用量: 23 },
            { date: "2023-05-17", 存储用量: 23 },
        ],
    },
    xAxis: {
        type: "category",
...
const RequestChart = () => {
    const [echartsRef] = useEcharts(requestOption);
	return (
		<div
...
const StoreChart=()=>{
    const [echartsRef] = useEcharts(storeOption);
	return (
		<div
			className="linechart-content"
			style={{
...
const ObjectChart=()=>{
    const [echartsRef] = useEcharts(ObjectsOption);
	return (
		<div
			className="linechart-content"
			style={{
...
const contentListNoTitle = {
	store: <StoreChart></StoreChart>,
	objectNumber: <ObjectChart/>,
...
const LineChartSwitch = () => {
	const [activeTabKey, setActiveTabKey] = useState("objectNumber");
...
export default LineChartSwitch;
